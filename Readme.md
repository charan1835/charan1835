...
- 🧩 Solving complex problems through **code and systems thinking**
- 📚 Constantly learning new technologies, patterns, and architectures

*I enjoy building things that are not just functional but **thoughtfully designed and scalable**.*
...
![Boltic](https://img.shields.io/badge/Boltic-0052CC?style=for-the-badge&logo=dataiku&logoColor=white)
...
- 🤖 **AI-powered web applications** that feel intelligent
- ✨ **Clean and minimal UI systems** focusing on great UX
- 🛠️ **Developer tools** that boost productivity
- 🏗️ **Scalable backend logic** and robust infrastructure
...
- 🔬 **Machine Learning workflows** and real-world implementations
- 🗣️ **Natural Language Processing (NLP)** concepts
- 📐 **Scalable full-stack architectures** and system design
- 🚀 **AI-driven product development** from 0 to 1
